...
const pool = new Pool({
  ...
  user:     process.env.USC_DB_USER     || 'uscuser',
  password: process.env.USC_DB_PASSWORD || 'uscpass'
});
...
//   export USC_DB_USER=uscuser
//   export USC_DB_PASSWORD=uscpass
//   export USC_DB_HOST=localhost
//   export USC_DB_PORT=5432

//   "${absoluteSchedulerPath}" --class-spots "${classCodesParam}" --preferences "${preferencesParam}" --semester ${semesterParam} --json --db-name usc_sched --db-user uscuser --db-password uscpass --db-host localhost --db-port 5432 2>&1
//   `;
